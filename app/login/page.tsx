      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6 ">
          ...
          return (
            ...
            <button onClick={()=> signIn(provider.id, {callbackUrl:"/"})} className="bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded flex items-center justify-center w-full hover:cursor-pointer">
              <svg
                role="img"
                viewBox="0 0 24 24"
